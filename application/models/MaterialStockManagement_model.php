<?php
	class MaterialStockManagement_model extends CI_Model{
		...
		public function Update_UpdatedStockMaterial_Info($data){
   ...
   purchase_discount = '$Update_StockMaterialDiscount' WHERE received_stock_id = '$Receivedstock_id'";
		...
		public function DeleteStockDetails($data){
		...
		public function Getreceived_Stock(){
		//extract($data);
		...
		public function Save_StockMaterial_Info($data){
