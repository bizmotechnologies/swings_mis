...
error_reporting(E_ERROR | E_PARSE);
		...
		/*--------------------------this fun for save raw material details-----------------------------------------------*/
			public function Save_RawStockMaterial_Info($data){
				...
				$sql = "SELECT avail_length from raw_materialstock WHERE raw_ID = '$Input_RawMaterialStock_ID' AND raw_OD ='$Input_RawMaterialStock_OD' AND material_id = '$Select_RawMaterials_Id'";
				//echo $sql;;
				...
				$sqlnew="INSERT INTO raw_materialstock(material_id,vendor_id,
					...
					avail_length,raw_quantity,accepted_date) 
		...
		{
				$sqlupdate = "UPDATE raw_materialstock SET avail_length = '$updated_length' WHERE material_id = '$Select_RawMaterials_Id'";
