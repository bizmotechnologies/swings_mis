...
<body class="w3-light-grey">
                ...
                <form id="regret_filter">
                  ...
                  <div class="w3-col l4 w3-padding-right">
                    ...
                    <div class="input-group">
                      ...
                      <input list="customerName_list" id="filter_customerName" name="filter_customerName" class="form-control" placeholder="Customers..." onchange="getWoId();">
            ...
            <div class="" id="ShowRaw_products" name="ShowRaw_products">
              ...
              <table class="table table-bordered table-responsive w3-small">            <!-- table starts here -->
                <tr class="w3-black">
                  ...
                  <th class="w3-center">product_name</th>              
                  <th class="w3-center">Material Id</th>              
                              
                                                 
                </tr>
              <tbody id="sortdatafrom_regrettable">
  ...
  <script>
    $(function(){
     $("#regret_filter").submit(function(){

      dataString = $("#regret_filter").serialize();
      //alert(dataString);
      // $("#sortdatafrom_womaster_quotation").html('<center><img width="50%" height="auto" src="'+BASE_URL+'css/logos/page_spinner3.gif"/></center>');

      $.ajax({
       type: "POST",
       url: "<?php echo base_url(); ?>/Report/Regrettable_report_controller/get_regrettable_data",
       data: dataString,
           ...
           {
           // alert(data);
             $('#sortdatafrom_regrettable').html(data);
           }
...
<script>
    ...
    // alert(customer_id);
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Report/Regrettable_report_controller/sort_byBranch",
        data: {
          cust_id: customer_id,
          From_date: From_date,
          To_date: To_date,
