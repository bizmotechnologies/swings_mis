...
<body class="w3-light-grey">
  ...
  <div class="w3-main" style="margin-left:120px;">
    ...
    <header class="w3-container" >
      <h5><b><i class="fa fa-files-o"></i> Profit Report</b></h5>
    </header>
                ...
                <form id="profit_filter">
                  ...
                  <div class="w3-col l4 w3-padding-right">
                    ...
                    <div class="input-group">
                      ...
                      <input list="customerName_list" id="filter_customerName" name="filter_customerName" class="form-control" placeholder="Customers..." onchange="getProfitreport();">
            ...
            <div class="" id="ShowRaw_products" name="ShowRaw_products">
              ...
              <table class="table table-bordered table-responsive w3-small">            <!-- table starts here -->
                <tr class="w3-black">
                  ...
                  <th class="text-center">vendor_name</th>
                  <th class="text-center">material_name</th>
                  <th class="text-center">Profit</th>  

                </tr>
              <tbody id="sortdatafrom_womaster_quotation">
  ...
  <script>
    $(function(){
     $("#profit_filter").submit(function(){

      dataString = $("#profit_filter").serialize();
      //alert(dataString);
      // $("#sortdatafrom_womaster_quotation").html('<center><img width="50%" height="auto" src="'+BASE_URL+'css/logos/page_spinner3.gif"/></center>');

      $.ajax({
       type: "POST",
       url: "<?php echo base_url(); ?>/Report/Report_controller/sort_Profitreport",
       data: dataString,
           ...
           {
           // alert(data);
             $('#sortdatafrom_womaster_quotation').html(data);
           }
 ...
 <script>
  function getReportForSort(){

    wo_id = $('#Customer_Filter [value="' + $('#CustomerForFilter').val() + '"]').data('value');
    $('#customer_idEnquiryFilter').val(wo_id);
  }
</script>
...
<script>
    ...
    function sort_byBranch(){
     ...
     // alert(customer_id);
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Report/Report_controller/sort_byBranch",
        data: {
          cust_id: customer_id,
          From_date: From_date,
          To_date: To_date,
