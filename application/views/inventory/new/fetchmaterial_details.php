                    ...
                    foreach ($multipleDiv_arr as $div) {  
                        ...
                        <div>
                            <div class="w3-col l12 w3-padding">
                                ...
                                <div class="w3-col l3 w3-left">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Product Name" value="<?php echo $div['product_name']; ?>" class="form-control" style="text-transform:uppercase;" id="product_nameForEnquiry_1" name="product_nameForEnquiry[]" required>
                                    </div>
                                </div>
                            ...
                            <div class="w3-col l12 w3-padding">
                                ...
                                <div class="w3-col l3 w3-left">
                                    <div class="input-group">
                                        ...
                                        <input list="Profiles_1" id="Select_Profiles_1" name="Select_Profiles[]" value="<?php echo $div['profile_id']; ?>" class="form-control" required type="text" placeholder="Select Profile Name">                                         
                            ...
                            <div class="w3-col l12 w3-tiny w3-padding w3-border-top w3-margin-top w3-margin-bottom"><!-- this div for material information and calculations-->
                                ...
                                $discount ='';
                                $final_Price = '';
                                foreach ($div['material_associated'] as $key  ){
                                    $material_id = $key['material_id'];
                                    $Select_ID = $key['Select_ID'];
                                    $Select_OD = $key['Select_OD'];
                                    $base_Price = $key['base_Price'];
                                    $Select_Length = $key['Select_Length'];
                                    $select_Quantity = $key['select_Quantity'];
                                    $discount = $key['discount'];
                                    $final_Price = $key['final_Price'];
                                } ?>
                                
                                <div class="w3-col l2">
                                    <label >MATERIAL</label> 
                                    <input list="Materialinfo_1" value="<?php echo $material_id; ?>" id="Select_material_1" name="Select_material[]" class="form-control" required type="text" placeholder="Material" onchange="GetMaterialInformation_ForEnquiry(1);">                                         
                                ...
                                <div class="w3-col l3">
                                    <div class="w3-col l4 s4 w3-padding-left">
                                        <label>ID</label> 
                                        <input list="MaterialID_1" value="<?php echo $Select_ID; ?>" id="Select_ID_1" name="Select_ID[]" class="form-control" required type="text" min="0" placeholder="ID" >                                         
                                        <datalist id="MaterialID_1">
                                        </datalist>
                                    </div>
                                    <div class="w3-col l4 s4 w3-padding-left">
                                        <label>OD</label> 
                                        <input list="MaterialOD_1" value="<?php echo $Select_OD; ?>" id="Select_OD_1" name="Select_OD[]" class="form-control" required type="text" min="0" placeholder="OD" >                                         
                                        <datalist id="MaterialOD_1">
                                        </datalist>
                                    </div>
                                    <div class="w3-col l4 s4 w3-padding-left">
                                        <label>LENGTH</label> 
                                        <input list="MaterialLength_1" value="<?php echo $Select_Length; ?>" id="Select_Length_1" name="Select_Length[]" class="form-control" required type="text" min="0" placeholder="Length" >                                         
                                ...
                                <div class="w3-col l1 w3-padding-left">
                                    ...
                                    <input id="base_Price_1" name="base_Price[]" value="<?php echo $base_Price; ?>" class="form-control" min="0" step="0.01" required type="number" placeholder="Base Price"  onfocus="GetMaterialBasePrice(1);">                                         
                                </div>

                                <div class="w3-col l1 w3-padding-left">
                                    <label>QUANTITY</label> 
                                    <input id="select_Quantity_1" name="select_Quantity[]" value="<?php echo $select_Quantity; ?>" class="form-control" min="0" required type="number" placeholder="Quantity" onkeypress="GetFinalPriceForMaterialCalculation(1);">                                         
                                </div>

                                <div class="w3-col l1 w3-padding-left">
                                    <label>DISCOUNT(%)</label> 
                                    <input id="discount_1" name="discount[]" <?php echo $discount; ?> class="form-control" required type="number" min="0" step="0.01" placeholder="Discount %." onkeypress="GetFinalPriceForMaterialCalculation(1);">                                         
                                </div>

                                <div class="w3-col l1 w3-padding-left">
                                    <label>FINAL&nbsp;PRICE</label> 
                                    <input id="final_Price_1" name="final_Price[]" <?php echo $final_Price; ?> class="form-control" required type="number" min="0" step="0.01" placeholder="Final Price" onfocus="GetFinalPriceForMaterialCalculation(1);">                                         
                                </div>
