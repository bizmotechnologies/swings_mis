...
<div class="w3-main" style="margin-left:120px;">
  ...
  <div class="row">
    ...
    <div class="col-lg-1">
      <a class="btn btn-primary" href="<?php echo base_url();?>Manage_materials">Materials</a>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-lg-1">
      <?php echo anchor("Manage_products/add_products", 'Add&nbsp;Products', ['class' => 'btn btn-primary']);?>
    </div>
